...
public class Options implements Serializable {
    ...
    private static final String OPTIONS_FILE = "options-dev.yml";
    ...
    public void setAppClassPath(List<String> appClassPath) {
    ...
    @JsonProperty
    @Option(names = {"-cpk", "--classpath-keywords"},
            description = "The keywords of classpath, which will be used to filter the classpath",
            defaultValue = "controller")
    private String[] classpathKeywords;

    public String[] getClasspathKeywords() {
        return classpathKeywords;
    }

    public void setClasspathKeywords(String[] classpathKeywords) {
        this.classpathKeywords = classpathKeywords;
    }

    @JsonProperty
    @Option(names = {"-rcf", "--route-config-file"},
            description = "The filename of route config file",
            defaultValue = "bootstrap.yml")
    private String routeConfigFile;

    public String getRouteConfigFile() {
        return routeConfigFile;
    }
    ...
    private static Options postProcess(Options options) {
        ...
        if (false && options.getClassPath() != null
