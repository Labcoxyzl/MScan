 ...
 */
 public class TaintManager {
    ...
    protected static final Descriptor TAINT_DESC = () -> "TaintObj";

    private final HeapModel heapModel;

    protected final Set<Obj> taintObjs = Sets.newHybridSet();
    ...
    public Obj makeTaint(SourcePoint sourcePoint, Type type, boolean isFunctional) {
        Obj taint = heapModel.getMockObj(TAINT_DESC, sourcePoint, type, isFunctional);
        taintObjs.add(taint);
        return taint;
    }
    ...
    public static boolean isTaintStatic(Obj obj) {
        return obj instanceof MockObj mockObj &&
                mockObj.getDescriptor().equals(TAINT_DESC);
    }
